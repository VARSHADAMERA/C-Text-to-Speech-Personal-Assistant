...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Varsha"<<endl;
        string phrase = "Good Morning varsha";
        ...
        cout<< "Good Afternoon varsha"<<endl;
        string phrase = "Good Afternoon varsha";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening varsha"<<endl;
        string phrase = "Good Evening varsha";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE VARSHA |"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE VARSHA";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="varsha")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you varsha...."<<endl<<endl;

                string phrase = "How can i help you varsha";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Varsha....."<<endl;
                    string phrase = "Hello Varsha";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Varsha !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Varsha!!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="open mspaint")
                {
                    cout<<"opening mspaint "<<endl;
                    string phrase = "opening mspaint";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\Users\\varsh\\AppData\\Local\\Microsoft\\WindowsApps\\mspaint.exe"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                else if(command=="open PowerPoint")
                {
                ...
                else if(command=="open book")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","D:\\4-1\\Big data analytics textbook.pdf",NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","D:\\videos\\VID-20201203-WA0006.mp4",NULL, NULL, SW_NORMAL);
                }

                else if(command=="bye" || command=="exit")
                {
                    cout<<"Good Bye Varsha, see you soon!"<<endl;
                    string phrase = "Good Bye varsha, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
